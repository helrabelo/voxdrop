#!/bin/bash
# Create DMG for VoxDrop distribution
set -e
...
# Check if app exists
if [ ! -d "dist/VoxDrop.app" ]; then
    echo "Error: dist/VoxDrop.app not found. Run ./scripts/build.sh first."
    exit 1
fi
